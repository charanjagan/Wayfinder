...
/** Server-component page guard: redirects to /admin/login (or /admin/change-password,
 * if the auto-generated first-run password hasn't been rotated yet) rather than
 * rendering anything. Call at the top of any page that requires an authenticated admin. */
...
/** Route-handler guard: returns a 401 NextResponse to short-circuit the caller with,
 * or null if the request carries a valid admin session. */
